...
srun --nodes=1 --exclusive --gpus=1 --ntasks=1 python train_1node_1gpu.py --lr 1e-4 --epochs 10 --batch_size 64 --out_path $OUT_PATH &
srun --nodes=1 --exclusive --gpus=1 --ntasks=1  python train_1node_1gpu.py --lr 1e-3 --epochs 10 --batch_size 64 --out_path $OUT_PATH &
